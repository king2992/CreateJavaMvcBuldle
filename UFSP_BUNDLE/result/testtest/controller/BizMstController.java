...
import nrf.ufsp.testtest.domain.BizMst;
import nrf.ufsp.testtest.dto.BizMstDto;
import nrf.ufsp.testtest.dto.BizMstSearchDto;
import nrf.ufsp.testtest.service.BizMstService;
...
public class BizMstController {
    ...
    @PostMapping("/api/admin/testtest/bizMstRegistExec")
    ...
    @PostMapping("/api/admin/testtest/bizMstUpdtExec/{bizCd}")
    ...
    @PostMapping("/api/admin/testtest/bizMstDeleteExec/{bizCd}")
    ...
    @PostMapping("/api/admin/testtest/getBizMstSearchList")
